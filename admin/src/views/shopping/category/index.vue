<template>
    <div>
        ...
        <el-card v-loading="pager.loading" class="!border-none" shadow="never">
            <el-button type="primary" v-perms="['shopping:shop_category:add']" @click="handleEditor('add')">
                <template #icon>
            ...
            <el-table :data="pager.lists" size="large" class="mt-4">
                ...
                <el-table-column label="操作" width="120" fixed="right">
                    <template #default="{ row }">
                        <el-button
                            v-perms="['shopping:shop_category:edit']"
                            type="primary"
                            link
                        ...
                        <el-button
                            v-perms="['shopping:shop_category:delete']"
                            type="danger"
                            link
