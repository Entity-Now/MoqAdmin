<template>
	<div>
		...
		<el-card
			...
			<el-form
				...
				<el-form-item label="是否置顶">
					<el-select
						v-model="queryParams.is_topping"
						class="w-[250px]">
						<el-option
							value=""
							label="全部" />
		...
		<el-card
			...
			<el-button
				type="primary"
				v-perms="['shopping:shop_commodity:add']"
			...
			<el-table
				...
				<el-table-column
					...
					<template #default="{ row }">
						...
						<el-tag v-else-if="row.deliveryType == 1"
							>自动发卡</el-tag
						>
						<el-tag v-else-if="row.deliveryType == 2"
							>人工发货</el-tag
						>
						<el-tag v-else-if="row.deliveryType == 3"
							>物流发货</el-tag
						>
					</template>
				</el-table-column>
