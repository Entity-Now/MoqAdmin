		...
		<el-card
			...
			<el-form-item
				...
				<div>
					...
					<div class="form-tips">
						用户登录注册时是否显示服务协议和隐私政策阅读功能
					</div>
				</div>
			</el-form-item>
			<el-form-item
				label="验证码验证："
				prop="disable_captcha">
				<div>
			...
			<el-form-item
				...
				<div>
					<el-radio-group v-model="formData.defaults">
						...
						<el-radio value="wx_mini">微信小程序登录</el-radio>
					</el-radio-group>
					<div class="form-tips">
						被选择为默认的登录方式项必须选一个,否则会显示异常
					</div>
				</div>
			</el-form-item>
			<el-form-item
			...
			<el-form-item
				...
				<div>
					<el-checkbox-group v-model="formData.login_other">
						...
						<el-checkbox value="wx_mini"
							>微信小程序登录</el-checkbox
						>
					</el-checkbox-group>
					<div class="form-tips">
						支持第三方授权登录,开启后新用户授权即自动注册账号
					</div>
				</div>
			</el-form-item>
		</el-card>
...
<script setup lang="ts">
	...
	const handleSubmit = async (): Promise<void> => {
		...
		loading.value = true;
		await loginApi.save(formData).finally(() => {
			setTimeout(() => {
				loading.value = false;
			}, 500);
		});
